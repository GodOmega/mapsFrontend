...
import getEmployeeWeekTime from "../../../services/enterprise/getEmployeeWeekTime";
...
const TimeWeekForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await getEmployeeWeekTime(getData, acces_token);
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        <div className="row">
          ...
          <div className="form-group">
            <label htmlFor="employee_email">Fecha inicial</label>
            <input
              className="form-control mb-2"
              ref={startDate}
              name="email"
          ...
          <div className="form-group">
            <label htmlFor="employee_email">Fecha final</label>
            <input
              className="form-control mb-2"
              ref={endDate}
              name="email"
